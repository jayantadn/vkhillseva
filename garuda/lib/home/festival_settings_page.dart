  ...
  Future<void> refresh() async {
    ...
    for (int i = 0; i < _festivals.length; i++) {
      _festivals[i] = FestivalSettings(
        name: _festivals[i].name,
        icon: _festivals[i].icon,
      );
    }
    FB().setValue(
      path: "${Const().dbrootGaruda}/Settings/NityaSevaList",
          ...
          trailing: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  callback.onDelete(FestivalSettings(name: title, icon: icon));
                },
              ),
            ],
          ),
              ...
              onPressed: () {
                setState(() {
                  if (old == null) {
                    ...
                    // edit the festival
                    int index = _festivals.indexWhere(
                      (element) =>
