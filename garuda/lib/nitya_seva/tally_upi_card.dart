...
class _TallyNotesPageState extends State<TallyUpiCardPage> {
  ...
  final TextEditingController _controller2500 = TextEditingController(
    text: '0',
  );
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const SizedBox(
              width: 8,
            ), // Add some space between the icon and the total amount
              ...
              decoration: BoxDecoration(
                ...
                color:
                    _validationSuccess
                        ? Colors.green
                        : Colors
                            .red, // Set the background color to green or red
              ),
              ...
              onPressed: () {
                if (_timestampSlot != null) {
                  ...
                  String dbDate = DateFormat(
                    "yyyy-MM-dd",
                  ).format(_timestampSlot!);
                  String dbSession = _timestampSlot!
                      .toIso8601String()
                      .replaceAll(".", "^");
                  FB().setJson(
                    path:
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: themeDefault,
      child: Scaffold(
        appBar: AppBar(title: const Text('Tally UPI / Card')),
