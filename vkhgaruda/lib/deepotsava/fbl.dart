...
class FBL {
  ...
  Future<void> listenForChange(String path, FBLCallbacks callbacks) async {
    final dbRef =
        FirebaseDatabase.instance.ref('record_db${Const().dbrootGaruda}/$path');
  ...
  Future<void> addStock(String stall, DeepamStock stock) async {
    final DatabaseReference dbRef = FirebaseDatabase.instance
        .ref('record_db${Const().dbrootGaruda}/deepotsava/$stall/stocks');
  ...
  Future<void> addSale(String stall, DeepamSale sale) async {
    final DatabaseReference dbRef = FirebaseDatabase.instance
        .ref('record_db${Const().dbrootGaruda}/deepotsava/$stall/sales/');
