# vkhsangeetseva — SangeetSeva App

SangeetSeva is the music seva app for ISKCON Vaikuntha Hill.
...
Create `key.properties` in `vkhsangeetseva/android/`:
...
Download `google-services.json` from the Firebase console into `vkhsangeetseva/android/app/`.
