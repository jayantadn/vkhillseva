...
class _SlotSelectionState extends State<SlotSelection> {
  ...
  Future<void> _onSelectSlot() async {
    DateTime? date = _nextavlslotKey.currentState!.nextAvailableDate;
    Slot? slot = _nextavlslotKey.currentState!.nextAvailableSlot;
    ...
    List<int> hrMin = Time().convertTo24hrFormat(slot.from);
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => EventDetails(
            ...
            selectedDate: date,
            slot: slot,
            eventStart: Time().convertStringToTime(date, slot.from),
            eventEnd: Time().convertStringToTime(date, slot.to),
          ),
        ),
      );
    }
